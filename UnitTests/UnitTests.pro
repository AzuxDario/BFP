...
include(HyperbolicTest/HyperbolicTest.pri)
include(InitializationTest/InitializationTest.pri)
include(InverseHyperbolicTest/InverseHyperbolicTest.pri)
include(Helpers/Helpers.pri)
include(PowerTest/PowerTest.pri)
include(RoundTest/RoundTest.pri)
include(TrigonometryTest/TrigonometryTest.pri)
